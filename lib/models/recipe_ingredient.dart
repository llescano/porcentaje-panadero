...
class RecipeIngredient {
  ...
  factory RecipeIngredient.fromMap(Map<String, dynamic> map) {
    return RecipeIngredient(
      ...
      displayUnit: map['display_unit'] != null ? MeasurementUnit.values[map['display_unit']] : null, // Leer displayUnit
      notes: map['notes'],
      isOptional: map['is_optional'] == 1,
      contributesToHydration: map['contributes_to_hydration'] == 1,
      bakerPercentage: (map['baker_percentage'] as num?)?.toDouble() ?? 0.0,
